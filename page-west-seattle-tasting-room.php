	...
	<div id="primary" <?php astra_primary_class(); ?>>
		...
		<div class="locationInfoRow">
					<div class="locationMap">
						<iframe src="<?php echo get_field('seattle_iframe_link_for_embed','option'); ?>" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
					...
					<div class="tastingRoomDetails">
						<div class="locationdetailsLineItem">
							...
							<a class="locationText" href="#seattleTastingList">View Our Tasting List</a>
						</div>
						<div class="locationdetailsLineItem hours">
							...
							<div class="locationHoursList">
								<?php if( have_rows('seattle_tasting_room_hours' ,'option') ): ?>
									<?php while( have_rows('seattle_tasting_room_hours' ,'option') ): the_row(); ?>
											<span class="storeHours"><?php echo the_sub_field('seattle_hours'); ?></span>
									<?php endwhile; ?>
								<?php endif; ?>
							</div>
						</div>
		...
		<div id="seattleTastingList" class="tastingListHeader">
			<div>Current Tasting List For Our West Seattle Location</div>
			<div>Tasting List Subject To Change and is Based on Availability</div>
		</div>
		<div class="tastingFlipCards">
			<?php if ( have_rows('seattle_tasting_list','option')):
				 while ( have_rows('seattle_tasting_list','option')): the_row(); ?>
					<div class="flip-card">
